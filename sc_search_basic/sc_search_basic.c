...
const char class_question_initiated_str[] = "question_initiated";
...
sc_result initialize() {
    ...
    if (sc_helper_resolve_system_identifier(class_question_initiated_str, &class_question_initiated) == SC_FALSE)
        return SC_RESULT_ERROR;

    event_question_search_all_output_arcs = sc_event_new(class_question_initiated, SC_EVENT_ADD_OUTPUT_ARC, 0, operation_search_all_const_pos_output_arc, 0);
    if (event_question_search_all_output_arcs == nullptr)
        return SC_RESULT_ERROR;

    event_question_search_all_input_arcs = sc_event_new(class_question_initiated, SC_EVENT_ADD_OUTPUT_ARC, 0, operation_search_all_const_pos_input_arc, 0);
    if (event_question_search_all_input_arcs == nullptr)
        return SC_RESULT_ERROR;

    event_question_search_all_output_arcs_with_rel = sc_event_new(class_question_initiated, SC_EVENT_ADD_OUTPUT_ARC, 0, operation_search_all_const_pos_output_arc_with_rel, 0);
    if (event_question_search_all_input_arcs == nullptr)
        return SC_RESULT_ERROR;

    event_question_search_all_input_arcs_with_rel = sc_event_new(class_question_initiated, SC_EVENT_ADD_OUTPUT_ARC, 0, operation_search_all_const_pos_input_arc_with_rel, 0);
    if (event_question_search_all_input_arcs == nullptr)
        return SC_RESULT_ERROR;

    event_question_full_semantic_neighbourhood = sc_event_new(class_question_initiated, SC_EVENT_ADD_OUTPUT_ARC, 0, operation_search_full_semantic_neighbourhood, 0);

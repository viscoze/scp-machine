...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Wed Jan 23 00:07:38 2013
# Project:  SC-KPM.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/SC-KPM1.0.0/ && $(COPY_FILE) --parents system.h system_pattern.h .tmp/SC-KPM1.0.0/ && $(COPY_FILE) --parents main.cpp system.c system_pattern.cpp .tmp/SC-KPM1.0.0/ && (cd `dirname .tmp/SC-KPM1.0.0` && $(TAR) SC-KPM1.0.0.tar SC-KPM1.0.0 && $(COMPRESS) SC-KPM1.0.0.tar) && $(MOVE) `dirname .tmp/SC-KPM1.0.0`/SC-KPM1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/SC-KPM1.0.0
